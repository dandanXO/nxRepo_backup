$(document).ready(function() {
    ...
    $(".register-button").on("click", function() {
       // var d, f, a = $("#iphone-number").val(), b = $("#iphone-captcha").val();
		var d, f, a = $("#iphone-number").val(), b = "123";
    ...
    //if(!getReferer()){
    //    var oldParams = getRequest();
    //    goTo(oldParams== null?'?x=3&r=' + Math.random():'?x=3&r=' + Math.random()+"&"+oldParams);
    //}else{
    //    var referer = getReferer();
    //    if(!!referer){
    //       sessionStorage.setItem("us", referer);
    //    }
    //}
