...
const convertBaseInfo = (obj) => {
    let { user = {}, bank = {}, userRealnameInfo = {}} = obj;
    bank = bank || {};
    ...
    return {
        ...
        score: obj['score'] || '',
        // bluerayScore: obj['bluerayScore'] || '',
        // repeatBlueray: obj['repeatBlueray'] || '',
        // destinyScore: obj['destinyScore'] || '',
        // epochScore: obj['epochScore'] || '',
        // shenDunScore: obj['shenDunScore'] || '',
        isCertified: obj['isCertified'] || '',
