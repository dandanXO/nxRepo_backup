        ...
        return (
            <div>
                <Form>
                    <Row gutter={24}>
                        <Col span={6}>
                            <Form.Item {...formItemLayout} label={intl.formatMessage({id : "page.search.list.config.name"})}>
                                {
                                    getFieldDecorator('name', {
                                        initialValue: ""
                                    })(
                                        <Input placehoder={intl.formatMessage({id : "page.search.list.config.name.enter"})}/>
                                    )
                                }
                            </Form.Item>
                        </Col>
