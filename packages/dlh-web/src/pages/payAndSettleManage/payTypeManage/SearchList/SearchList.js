                            ...
                            <Form.Item {...formItemLayout} label={intl.formatMessage({id : "windowPage.payment.method"})}>
                                {
                                    getFieldDecorator('typeName', {
                                        ...
                                        <Input placehoder={intl.formatMessage({id : "windowPage.payment.method.enter"})}/>
                                    )
                                }
                            </Form.Item>
                        </Col>
                        <Col lg={12} xl={8}>
                            <Form.Item {...formItemLayout} label={intl.formatMessage({id : "windowPage.payment.method.alias"})}>
                                {
                                    getFieldDecorator('typeAlias', {
                                        initialValue: ""
                                    })(
                                        <Input placehoder={intl.formatMessage({id : "windowPage.payment.method.alias.enter"})}/>
                                    )
                                }
                            </Form.Item>
                        </Col>
