...
export const OOD_GET_OVERDUE_COLLECTOR = 'OOD_GET_OVERDUE_COLLECTOR';
export const OOD_SET_OVERDUE_COLLECTOR = 'OOD_SET_OVERDUE_COLLECTOR';
...
export const oodGetOverdueCollector = () => ({ type: OOD_GET_OVERDUE_COLLECTOR });
export const oodSetOverdueCollector = (data) => ({ type: OOD_SET_OVERDUE_COLLECTOR, data });
