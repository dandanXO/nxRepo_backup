                            ...
                            <Form.Item {...formItemLayout} label={intl.formatMessage({id : "windowPage.repayment.type"})}>
                                {
                                    getFieldDecorator('backType', {
                                        ...
                                        <Select>
                                            <Option value={''}><FormattedMessage id="page.search.list.no.restrict" /></Option>
                                            <Option value={'5'}><FormattedMessage id="windowPage.full.repayment.overdue" /></Option>
                                            <Option value={'6'}><FormattedMessage id="windowPage.part.repayment.overdue" /></Option>
                                            <Option value={'7'}><FormattedMessage id="windowPage.reduce.repayment" /></Option>
