...
class SearchList extends Component{
    ...
    handleExportClick = () => {
        const { form: { getFieldsValue }, handleExport } = this.props;
        handleExport(getFieldsValue());
    }
                    ...
                    <Row gutter={40}>
                        ...
                        <Col span={8}>
                            <Form.Item style={{textAlign:'right'}}>
                                ...
                                <Button type={'danger'} style={{marginLeft:'10px'}} onClick={this.handleExportClick}><FormattedMessage id="page.table.export" /></Button>
                            </Form.Item>
                        </Col>
                    </Row>
                </Form>
