...
class LoanToFailModal extends Component{
    layout = {
        labelCol: {
            span: 10
        },
    ...
    render() {
        ...
        return (
            <Modal
                ...
                width={600}
                visible={visible}
                title={intl.formatMessage({id : "windowPage.back.loan.fail"})}
            ...
            <div>
                ...
                <div className={styles.desc_div}>
                    <span className={styles.desc}>
                        ...
                        <p>&nbsp;<FormattedMessage id="page.loanToFail.comment5" /><b><FormattedMessage id="page.loanToFail.comment6" /></b><FormattedMessage id="page.loanToFail.comment7" /></p>
