...
import {
    GetNewCustomersDailyConversionRatesProps,
    GetNewCustomersDailyConversionRatesRequestQuerystring,
} from './types/NewCustomersDailyConversionRatesTypes/getNewCustomersDailyConversionRates';
...
const NewCustomersDailyConversionRatesApi = API.injectEndpoints({
    ...
    endpoints: (builder) => ({
        ...
        getNewCustomersDailyConversionRates: builder.query<
            GetNewCustomersDailyConversionRatesProps,
            GetNewCustomersDailyConversionRatesRequestQuerystring
        >({
        ...
        postNewCustomersDailyConversionRatesDownload: builder.mutation<
            Blob,
            PostNewCustomersDailyConversionRatesDownloadRequestBody
        >({
