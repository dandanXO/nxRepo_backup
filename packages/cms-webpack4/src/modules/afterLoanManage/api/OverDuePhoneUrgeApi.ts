...
const CollectOverDuePhoneUrgeApi = API.injectEndpoints({
    ...
    endpoints: (builder) => ({
        // [GET] 逾期電催列表
        getCollectOverDuePhoneUrgeList: builder.query<
            GetCollectOverDuePhoneUrgeListResponse,
            GetCollectOverDuePhoneUrgeListQueryString
        >({
        ...
        // [POST] 新增逾期催收紀錄
        postCollectOverDuePhoneUrgeRecord: builder.mutation<
            PostCollectOverDuePhoneUrgeRecordResponse,
            PostCollectOverDuePhoneUrgeRecordRequest
        >({
...
export const { useLazyGetCollectOverDuePhoneUrgeListQuery, usePostCollectOverDuePhoneUrgeRecordMutation } =
