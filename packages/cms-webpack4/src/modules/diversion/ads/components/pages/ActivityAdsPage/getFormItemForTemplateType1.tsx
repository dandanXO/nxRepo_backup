        ...
        <Form.Item label="广告列表" required>
            <Form.List name="contents">
                {(fields, { add, remove }) => {
                    ...
                    return (
                        <>
                            <Divider orientation="left" style={{ color: '#ec606a' }}>
                                主打广告
                            </Divider>
                            <Row gutter={[8, 8]}>
                                <Col span={24}>
                                    <Form.Item required label={'广告标题'} name={[0, 'payload', 'title']}>
                                ...
                                <Col span={12}>
                                    <Form.Item required label={'广告说明'} name={[0, 'payload', 'description']}>
                                ...
                                <Col span={12}>
                                    <Form.Item>
                                        <Button
                                            type="dashed"
                                            onClick={() =>
                                                add(getDefaultActivity1BannerContent(ads.length + 1), ads.length)
                                            }
                                            block
                                            icon={<PlusOutlined />}
                                        >
