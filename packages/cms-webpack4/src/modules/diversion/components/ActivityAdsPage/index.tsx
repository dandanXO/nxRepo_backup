...
const ActivityAdsPage = (): JSX.Element => {
    // NOTE: GET list and item
    const [triggerGetList, { currentData: currentItemListData }] = useLazyGetActivitiesQuery({
        pollingInterval: 0,
    ...
    const systemReloadEditUseCase = useCallback(
        (currentFormData) => {
            // NOTICE: form
            // NOTE: form - menu
...
export default ActivityAdsPage;
