...
export const OrderDetailContent = ({
    ...
    const tabsItems = useMemo(() => {
        ...
        const collectRecordColumns = [
            ...
            { title: t('urgeCollection:stage'), key: 'overdueStage', dataIndex: 'overdueStage', width: '8%', ellipsis: true, render: (_, { overdueStage }) => CurrentDayOverDueStageEnum[overdueStage]?.text || overdueStage },
