...
import { validateNum, validateValue } from './validatePreOrPostInterestGroups';
    ...
    useEffect(() => {
        ...
        if (touchField === 'num') {
            setCustomAntFormFieldError((prev) => {
                ...
                return {
                    ...prev,
                    [isMultiGroup ? parentName : (fieldName as string)]:
                        prev[isMultiGroup ? parentName : (fieldName as string)],
                };
            });
        }
