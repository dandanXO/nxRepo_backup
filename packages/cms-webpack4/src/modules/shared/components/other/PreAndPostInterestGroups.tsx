                            ...
                            <>
                                        ...
                                        <div>
                                            <CustomLabel style={{ width: 125 }}>
                                                <Space>
                                                    ...
                                                    <Tooltip
                                                        title={
                                                            <div>
                                                                ...
                                                                <div>
                                                                    ▪
                                                                    起始期数1，前置利息10%，后置利息15%＋起始期数4，前置利息8%，后置利息12%，则1~3期费率同起始期数1，第4期之后费率同起始期数4。
                                                                </div>
                                                                <div>▪ 期数建议由小至大填写。</div>
                                                            </div>
                                                        }
                                                    >
                                                        <InfoCircleOutlined
                                                            style={{ fontSize: '12px', color: '#c0bfbf' }}
                                                        />
                                                    </Tooltip>
                                                </Space>
                                            </CustomLabel>
                                ...
                                <Space key={key} size={8} style={{ marginBottom: 0 }} align="baseline">
                                    <Form.Item
                                        ...
                                        name={[name, 'num']}
                                        validateStatus={
                                            customAntFormFieldError?.productInterestRatePairs?.[index]?.num
                                                ?.validateStatus || ''
                                        }
                                        help={
                                            customAntFormFieldError?.productInterestRatePairs?.[index]?.num?.help || ''
                                        }
                                        initialValue={''}
                                    >
                                    ...
                                    <Form.Item
                                        ...
                                        validateStatus={
                                            customAntFormFieldError?.productInterestRatePairs?.[index]?.preInterest
                                                ?.validateStatus || ''
                                        }
                                        help={
                                            customAntFormFieldError?.productInterestRatePairs?.[index]?.preInterest
                                    ...
                                    <Form.Item
                                        ...
                                        validateStatus={
                                            customAntFormFieldError?.productInterestRatePairs?.[index]?.postInterest
                                                ?.validateStatus || ''
                                        }
                                        help={
                                            customAntFormFieldError?.productInterestRatePairs?.[index]?.postInterest
                                    ...
                                    <Form.Item
                                        ...
                                        validateStatus={
                                            customAntFormFieldError?.productInterestRatePairs?.[index]?.plusAmount
                                                ?.validateStatus || ''
                                        }
                                        help={
                                            customAntFormFieldError?.productInterestRatePairs?.[index]?.plusAmount
