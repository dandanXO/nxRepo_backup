...
import { Card, Col, Form, Input, Modal, Row, Select, Tabs, Image, Descriptions, Table } from 'antd';
const { Item } = Descriptions;
import { useGetUserDetailQuery } from "../api/UserApi";
import { GetUserDetailRequestQuerystring, GetUserDetailResponse } from '../api/types/getUserDetail';
