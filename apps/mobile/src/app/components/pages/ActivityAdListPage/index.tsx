...
const ActivityAdListPage = (props: IActivityAdListPage) => {
    const [triggerGetActivityAd, { currentData: currentData }] =
    ...
    switch (type) {
        case "1": {
            return (
                <AdTemplate1
                    data={getTemplate1AdTemplate1Data(currentData?.contents)}
                />
            );
        }
        case "2": {
            return (
                <AdTemplate2
                    data={getTemplate2AdTemplate1Data(currentData?.contents)}
                />
            );
        }
        case "3": {
            return (
                <AdTemplate3
                    data={getTemplate3AdTemplate1Data(currentData?.contents)}
                />
            );
        }
        default:
...
export const DemoActivityAdListPage = (props: IActivityAdListPage) => {
    ...
    switch (type) {
        case "1": {
            adTemplate = (
                <AdTemplate1 data={props.data || MockAdTemplate1Data} />
            );
            break;
        }
        case "2": {
            adTemplate = (
                <AdTemplate2 data={props.data || MockAdTemplate2Data} />
            );
            break;
        }
        case "3": {
            adTemplate = (
                <AdTemplate3 data={props.data || MockAdTemplate3Data} />
            );
            break;
        }
        default:
