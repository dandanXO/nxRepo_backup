    ...
    return (
        <AdTemplate2Container>
            ...
            >
                ...
                <Button bgColor={"#ef7e3a"}>
                    {props.data?.brandCard.actionName}
                </Button>
            </BrandCard>
            <CardContainer>
                {/*NOTE: Top*/}
                ...
                >
                    ...
                    <Button bgColor={"#59c19e"}>
                        {props.data?.topCard.actionName}
                    </Button>
                </Card>
                {/*NOTE: Bottom*/}
                <Card
                ...
                >
                    <Title color={"#485d8c"}>
                        {props.data?.bottomCard.title}
                    </Title>
                    <Button bgColor={"#5175aa"}>
                        {props.data?.bottomCard.actionName}
                    </Button>
                </Card>
            </CardContainer>
        </AdTemplate2Container>
