    ...
    return (
        <AdTemplate3Container>
            ...
            >
                ...
                <Description>
                    <Description1 color={"#fff"}>
                        {props.data?.brandCard.description1}
                    </Description1>
                    <Description2 color={"#fff"}>
                        {props.data?.brandCard.description2}
                    </Description2>
                </Description>
            ...
            >
                ...
                <Description>
                    <Description1 color={"#ec606a"}>
                        {props.data?.card.description1}
                    </Description1>
                    <Description2 color={"#a2a2a2"}>
                        {props.data?.card.description2}
                    </Description2>
                </Description>
