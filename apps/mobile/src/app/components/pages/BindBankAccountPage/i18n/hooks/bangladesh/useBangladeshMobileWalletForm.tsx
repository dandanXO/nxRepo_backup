...
export const useBangladeshMobileWalletForm = (
    props: IUseBangladeshMobileWalletForm
) => {
    ...
    const validateMobileWalletAccount = useCallback(() => {
        ...
        const scheme = z.string().length(10, message);
    ...
    const validateConfirmedMobileData = useCallback(() => {
        ...
        const confirmedMobileDataScheme = z
            .string()
            .refine((confirmedBankcardNo) => confirmedMobile === mobile, {
                message: t(
    ...
    const confirm = useCallback(() => {
        ...
        if (!mobileData.isValidation || !confirmedMobileData.isValidation)
            return;
