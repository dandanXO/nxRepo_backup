    ...
    return (
        <IndexPage>
            <div>
                ...
                <div>
                    Environment: {environment.production ? "正式機" : "測試機"}
                </div>
            ...
            <button
                onClick={() => {
                    window.open(
                        "http://localhost:4001/?showtranslations",
                        "_blank"
                    );
                }}
            >
            ...
            <li>
                <Link
                    to={`${AppFlag.pagePrefix}activity-list?phoneNo=9049334242`}
                >
                    ActivityAdList
                </Link>
            </li>
            ...
            <li>
                <Link to={`${AppFlag.pagePrefix}activity-list-dev`}>
                    (DEV)ActivityAdList
                </Link>
            </li>
            ...
            <li>
                <Link
                    to={
                        `${AppFlag.pagePrefix}bank-bind?token=` +
                        getToken() +
                        "&" +
                        getCardholderName()
                    }
            ...
            <li>
                <Link
                    to={`${AppFlag.pagePrefix}extend-details?` + queryString()}
                >
                    extendDetailsPage
                </Link>
            </li>
            <li>
                <Link
                    to={
                        `${AppFlag.pagePrefix}upload-payment-receipt?` +
                        queryString()
                    }
                >
            ...
            <li>
                <Link
                    to={
                        `${AppFlag.pagePrefix}product-ad-modal-list?token=` +
                        getToken()
                    }
                >
