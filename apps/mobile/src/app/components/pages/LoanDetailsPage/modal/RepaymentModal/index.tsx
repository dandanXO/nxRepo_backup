...
export const RepayAndApplyButton = styled(NotificationButton)`
    ...
    background: ${(props) =>
        props.disable ? "#C0C0C0" : props.theme.button.primary.main};
`;
    ...
    const handleConfirm = () => {
        ...
        if (environment.country === AllCountryInstance.IndiaCountry.country) {
            if (Number(props.repayBalance) > 0) {
                props.handlePostRepayCreate(false, false, props.repayBalance);
            }
        } else {
                    ...
                    return (
                        <RepaymentModalContainer>
                            ...
                            <SectionOptions>
                                ...
                                {/*NOTICE: 印度版不顯示還款再借*/}
                                {environment.country !==
                                    AllCountryInstance.IndiaCountry.country && (
                                    <SectionButton>
                                        <RepayAndApplyButton
                                            ...
                                            onClick={() => {
                                                if (radioValue !== "balance")
                                                    return;
                                                if (props.isRepayTypesFetching)
                                                    return;
                                                props.setShowRepaymentModal(
                                                    false
                                                );
