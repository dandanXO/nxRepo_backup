...
interface IPhilippinesPaymentResultPageProps {
  path: 'complete' | 'failed';
  resultImage: string;
}

const PhilippinesPaymentResultPage = ({
  path,
  resultImage,
}: IPhilippinesPaymentResultPageProps) => {
  return (
...
export default PhilippinesPaymentResultPage;
