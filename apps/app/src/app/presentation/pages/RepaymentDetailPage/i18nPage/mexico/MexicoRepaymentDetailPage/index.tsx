      ...
      <div className={`px-6`}>
        ...
        <div className={`my-3 flex flex-row text-white`}>
          {extendable !== undefined && extendable && (
            ...
            >
              <Button outlineTheme={'round'} type={'secondary'} text={'Extend'} />
            </div>
          )}
          ...
          {status !== 'PAY_OFF' && status !== 'EXTEND' && (
            ...
            >
              <Button outlineTheme={'round'} text={'Repay'} />
            </div>
          )}
        </div>
        ...
        {(status === 'UNPAID' || status === 'OVERDUE') && (
          <>
            ...
            <div className={`my-3 flex flex-col`}>
              ...
              >
                <Button type={'ghost'} outlineTheme={'round'} className={`w-full`} text={'Upload Receipt'} />
              </div>
            </div>
          </>
        )}
