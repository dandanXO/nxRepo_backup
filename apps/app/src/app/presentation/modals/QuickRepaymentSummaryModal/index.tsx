    ...
    <div className={"quick-repayment-modal z-10 w-screen h-screen bg-white p-4 fixed top-0 bottom-0 flex flex-col"}>
      ...
      <div className={"footer flex-1"}>
        ...
        <div className={"text-xs font-light text-gray-400 mb-2"}>
          ...
          <span className={"text-blue-500 underline"} onClick={props.onClickLoanAgreement}> Loan Agreement </span>
          <span>carefully.</span>
        </div>

        <Button text={"Confirm"} bgColor={"bg-[#F58B10]"} onClick={props.onConfirmApply}/>
