...
export const i18nRepaymentModal: i18nComponent = {
  namespace: 'modals/i18nRepaymentModal',
  translation: {
    en_US: {
      ...
      'In order to protect your rights, we strongly recommend you take a screenshot and upload your UTR number after completing the repayment and return to the APP to upload your repayment receipt.': 'In order to protect your rights, we strongly recommend you take a screenshot and upload your UTR number after completing the repayment and return to the APP to upload your repayment receipt.',
      ...
      'To protect your rights, we strongly recommend that you take a screenshot of the repayment details after completing the repayment, and upload your screenshot to the app.': 'To protect your rights, we strongly recommend that you take a screenshot of the repayment details after completing the repayment, and upload your screenshot to the app.',
      ...
      //ERROR MESSAGE
      'This field cannot be left blank or 0.':'This field cannot be left blank or 0.',
      'Amount cannot be greater than the repayment balance.':'Amount cannot be greater than the repayment balance.',
      'Numbers only. Please try again.':'Numbers only. Please try again.',
    },
    es_MX: {
      'Repay': 'Repagar',
      'Repay Full Amount': 'Reembolsar el monto total',
      'Partial Repayment': 'Reembolso parcial',
      'Payment Amount': 'Monto de Pago',
      'Payment Method': 'Método de Pago',
      'Coupon (MXN)': 'Cupón (MXN)',
      'Select': 'Seleccionar',
      ...
      'Amount cannot be greater than the repayment balance.':'La cantidad no puede ser mayor al saldo de pago.',
      'Numbers only. Please try again.':'Solo se permiten números. Por favor, inténtalo de nuevo.',
    },
    bn_BD: {
      Repayment: 'পরিশোধের',
      // Radio
      ...
      'Cancel': 'বাতিল করুন',
      'Attention': 'মনোযোগ',
      '1. Before repayment, please make sure that youhave enough balance on your bank account.':
        '1. পরিশোধের আগে, অনুগ্রহ করে নিশ্চিত করুন যে আপনার ব্যাঙ্ক অ্যাকাউন্টে যথেষ্ট ব্যালেন্স আছে।',
