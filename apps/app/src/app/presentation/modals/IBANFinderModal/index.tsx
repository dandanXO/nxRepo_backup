...
const IBANFinderModal = (props: any) => {
    ...
    return (
      <div className="text-black text-left p-5">
        <div className="text-sm font-bold">
          How to Get Bank Card IBAN Number?
        </div>
        <Divider />
  ...
  const renderByWallet = () => {
    return (
      <div className="text-black text-left p-5">
        <div className="text-sm font-bold">
          How to Get Easypaisa and JazzCash IBAN Number?
        </div>
        <Divider />
        <div className="p-3 bg-[#F6F6F6] mt-3 ">
          <TopicContent
          ...
          <MethodContent
            ...
            text={
              <div>
                ...
                <div>
                  4. On the new screen, you will see the Easypaisa IBAN Number
                  of your account.
                </div>
                <div className="my-2">
                ...
                <div>
                  ...
                  account. Now, you can receive funds from across the world
                  using the IBAN Number of your Easypaisa account.
                </div>
              </div>
            }
          />
          ...
          <MethodContent
            ...
            text={
              <div>
                If you don’t have the android app then you can simply make a
                call at JazzCash helpline. Dial 4444 from your Jazz number or
