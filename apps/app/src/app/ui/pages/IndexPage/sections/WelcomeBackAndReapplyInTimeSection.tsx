...
export const WelcomeBackAndReapplyInTimeSection = (props: Props) => {
  return (
    <div className={'flex w-full flex-col items-center'} data-testing-id='welcomBackTimer'>
      ...
      <div className={'flex w-[240px] flex-row rounded-md border border-cTextFields-outline-main py-2 px-2'}>
        <div className={'flex flex-1 flex-col items-center'}>
          ...
          <div className={'label text-xs text-ctext-tertiary'}>days</div>
        </div>
        <div className={'flex flex-1 flex-col items-center'}>
          ...
          <div className={'label text-xs text-ctext-tertiary'}>hours</div>
        </div>
        <div className={'flex flex-1 flex-col items-center'}>
          ...
          <div className={'label text-xs text-ctext-tertiary'}>minutes</div>
        </div>
        <div className={'flex flex-1 flex-col items-center'}>
          ...
          <div className={'label text-xs text-ctext-tertiary'}>seconds</div>
        </div>
      </div>
    </div>
  );
