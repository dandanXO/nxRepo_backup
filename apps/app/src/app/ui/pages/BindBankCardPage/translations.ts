...
export const i18nBankBindAccountPage: i18nComponent = {
  ...
  translation: {
    ...
    es_MX: {
      ...
      'To expedite your request, please make sure the name and phone number on the card match the information you provide':
        'Para acelerar su solicitud, asegúrese de que el nombre y el número de teléfono en la tarjeta coincidan con la información que proporcionó.',
      ...
      'Please make sure your account number match.':
        'Asegúrate de que tu número de cuenta coincida.',
      'Account number must be {{inputLength}} digits only.':
        'Número de cuenta debe tener exactamente {{inputLength}} dígitos.',
    },
    bn_BD: {
      // NOTICE: common
      Save: 'একমত',
      ...
      'Confirm Account Number': 'অ্যাকাউন্ট নম্বর নিশ্চিত করুন',
      // "Please make sure your account number match.": "Please make sure your account number match.",
      'Unchangeable after linked, please check before submission.':
        'লিঙ্ক করার পরে অপরিবর্তনীয়, জমা দেওয়ার আগে চেক করুন।',
