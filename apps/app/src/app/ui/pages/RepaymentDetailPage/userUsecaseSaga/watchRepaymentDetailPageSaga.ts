...
export function* watchRepaymentDetailPageSaga() {
  yield takeLatest(
    RepaymentDetailPageUseCaseActions.system.showReservation.type,
    errorFallback,
    systemShowReservationSaga
  );
  yield takeLatest(
    RepaymentDetailPageUseCaseActions.user.reserve.type,
    errorFallback,
    userReserveSaga
  );
  yield takeLatest(
    RepaymentDetailPageUseCaseActions.user.repaymentDetail.type,
    errorFallback,
    userRepaymentDetailSaga
  );
  ...
  yield takeLatest(
    RepaymentDetailPageUseCaseActions.user.repayData.type,
    errorFallback,
    userRepayDataSaga
  );
}
