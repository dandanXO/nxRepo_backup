    ...
    <Modal outlineTheme={'round'}>
      ...
      <div className={`mt-6 flex flex-row text-white`}>
        <div className={`mr-1.5 grow`}>
          <Button type={'ghost'} ghostTheme={'none'} onClick={() => navigate(-2)} text={t('Cancel')} />
        </div>
        <div className={`ml-1.5 grow`}>
          <Button outlineTheme={'round'} onClick={props.handleConfirm}  text={t('Confirm')} disable={props.isPostExtendCreateLoading}/>
        </div>
      </div>
      </div>
    </Modal>
