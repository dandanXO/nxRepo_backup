...
export const QuickRepaymentSummaryModal = (props: Props) => {
  ...
  return (
    <div
      className={cx(
        'quick-repayment-modal fixed top-0 bottom-0 flex h-full  w-screen flex-col bg-white p-4'
      )}
    >
      <div>
            ...
            <div className={'item-list'}>
              ...
              {props.state.indexAPI?.chargeFeeDetails.map((key) => {
                ...
                const keyMapValue: Record<FeeRateKeyEnum, any> = {
                  [FeeRateKeyEnum.LOAN_INTEREST]: formatPrice(
                    props.calculatingSummary.interest
                  ),
                  [FeeRateKeyEnum.PROCESSING_FEE]: formatPrice(
                    props.calculatingSummary.processingFee
                  ),
                  [FeeRateKeyEnum.SERVICE_FEE]: formatPrice(
                    props.calculatingSummary.serviceCharge
                  ),
                ...
                return (
                  <div
                    className={'item flex flex-row justify-between font-light'}
                  >
              ...
              <div className={'item flex flex-row justify-between font-light'}>
                ...
                <div className={'value'}>
                  {props.calculatingSummary.repaymentDate
                    ? formatDate(props.calculatingSummary.repaymentDate)
                    : ''}
                </div>
              </div>
            </div>
      ...
      <div className={'products max-h-[calc(100vh-142px-108px-82px-32px)] '}>
        ...
        <div className={'flex h-full flex-col overflow-scroll pb-5'}>
