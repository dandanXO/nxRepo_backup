...
export const i18nReservationSuccessModal: i18nComponent = {
  ...
  translation: {
    ...
    es_MX: {
      ...
      'Congratulations! Your reservation is successful.':
        '¡Felicidades! Su reserva es exitosa.',
      'After the order is confirmed, you can view it on the "Payment" page. The final outcome will be based on the audit results.':
        'Una vez confirmado el pedido, puede verlo en la página "Pago". El resultado final se basará en los resultados de la auditoría.',
      OK: 'OK',
    },
    bn_BD: {},
  },
