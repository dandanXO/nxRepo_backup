...
export const i18nExtendConfirmModal: i18nComponent = {
  ...
  translation: {
    ...
    es_MX: {
      Extend: 'Extender',
      'Extensions are intended for situations where you are genuinely experiencing financial difficulties and are unable to fully repay the amount owed.':
        'Las extensiones están destinadas a situaciones en las que realmente está experimentando dificultades financieras y no puede pagar la cantidad adeudada en su totalidad.',
      'We recommend that you prioritize full repayment when possible for a higher credit limit.':
        'Le recomendamos que priorice el reembolso completo cuando sea posible para un límite de crédito más alto.',
