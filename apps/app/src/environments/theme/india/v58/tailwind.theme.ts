...
const theme: ICustomTailwindTheme = {
  // NOTE: Color
  primary_main: '#FF5516',
  primary_variant: '#DB3810',
  primary_assistant: '#FFE8E5',

  secondary_main: '#75EDE9',
  secondary_variant: '#55C5CB',
  secondary_assistant: '#E4FEF4',

  tertiary_main: '#FFAC73',
  tertiary_variant: '#DB8354',
  ...
  custom_state_warning_main: '#FFE895',
