...
const theme: ICustomTailwindTheme = {
    ...
    custom_bg_homepage_button:'linear-gradient(178.76deg, #50AFA7 1.58%, #3A9596 99.46%)', // 首頁按鈕 Get my limit
    custom_bg_button:'linear-gradient(178.76deg, #50AFA7 1.58%, #3A9596 99.46%)', // PK primary button
