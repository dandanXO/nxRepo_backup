...
const theme: ICustomTailwindTheme = {
  ...
  tertiary_main: '#9ADFFF',
  tertiary_variant: '#70B2DB',

  // NOTE: State
  custom_state_disable_main: '#D1D1D1',
  custom_state_disable_variant: '#8A8A8A',
  ...
  custom_state_error_main: '#FF5349',
  ...
  custom_bg_tertiary: '#F2FDFF',
  custom_bg_homepage_button: '#0F78CF', // 首頁按鈕 Get my limit

  // NOTE: Text
  custom_text_primary: '#1F1F1F',
  custom_text_secondary: '#777777',
