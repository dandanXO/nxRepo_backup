...
export const NoData = () => {
  return (
    <div className="h-full mt-0 md:pt-2 lg:pt-3 py-9 lg:py-11 border-dashed border-[#b3b3b3] flex flex-col justify-center w-full items-center border-2 rounded-lg">
