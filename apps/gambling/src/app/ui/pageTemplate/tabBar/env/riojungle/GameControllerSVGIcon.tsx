...
export const GameControllerSVGIcon = (props:IICON) => {
  ...
  return (
    <svg width={props.size || "32"} height={props.size || "32"} viewBox={`0 0 ${props.size} ${props.size}`} fill="none"  xmlns="http://www.w3.org/2000/svg">
      <path d="M19 13.5H23" stroke={props.color || "white"} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" transform={`scale(${size})`}/>
      <path d="M9 13.5H13" stroke={props.color || "white"} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" transform={`scale(${size})`}/>
      <path d="M11 11.5V15.5" stroke={props.color || "white"} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" transform={`scale(${size})`}/>
