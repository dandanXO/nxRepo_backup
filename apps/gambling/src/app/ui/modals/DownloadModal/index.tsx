...
export const DownloadModal = (props: IInitialChargeModal) => {
  ...
  return (
    <div className={"z-[999] fixed left-0 top-0 right-0 bottom-0 flex flex-col flex justify-center items-center w-full h-full bg-[rgba(0,0,0,0.65)]"} onClick={(event: any) => {
      ...
      <Container
        className={"border-solid border-[1px] border-[var(--primary-assistant)] text-white px-10 py-10 w-[400px] w-min-[80vh] w-max-[400px] h-auto bg-gradient-to-b from-[var(--background-modal-from)] to-[var(--background-modal-to)] rounded-2xl flex flex-col items-center relative text-center"}
        onClick={(event: any) => {
      ...
      >
        ...
        <section className={"mb-2"}>
          ...
          <DownloadButton className={"mb-2 flex flex-row justify-center items-center"} onClick={()=>handleDownload('android')}>
            <img
