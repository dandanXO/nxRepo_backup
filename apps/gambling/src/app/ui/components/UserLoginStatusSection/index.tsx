          ...
          <div className="flex" style={{ width: "300px" }}>
            <button
              ...
              className={cx("flex-1 font-bold pb-2 ml-7 mr-7", {
                "text-[#01FF52]": switchToLoginOrRegister === "login",
                ...
                "border-b-[#01FF52]": switchToLoginOrRegister === "login",
            ...
            <button
              ...
              className={cx("flex-1 font-bold pb-2 mr-7 ml-7",{
                "text-[#01FF52]": switchToLoginOrRegister === "register",
                ...
                "border-b-[#01FF52]": switchToLoginOrRegister === "register",
              })}
            >
              Cadastre-Se
            </button>
        ...
        {switchToLoginOrRegister === "forget" && (
          <button
            ...
            className={cx("font-bold pb-2",{
              "text-[#01FF52]": switchToLoginOrRegister === "forget",
              "border-b-2": switchToLoginOrRegister === "forget",
              "border-b-solid": switchToLoginOrRegister === "forget",
              "border-b-[#01FF52]": switchToLoginOrRegister === "forget",
            })}
          >
            Esqueça a senha
          </button>
