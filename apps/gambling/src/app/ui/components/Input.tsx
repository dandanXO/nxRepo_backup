...
export const InputSection = styled.button<{
  focus?: boolean;
  validation?: boolean;
}>`
  ...
  return (
    <div className={"mb-4"}>
      <div className={"flex flex-row justify-center items-center"}>
        ...
        }} className={cx(props.className, "w-full rounded-xl", {
        ...
        >
          ...
          {props.children ? (props.children) : (
            <input
              // ref={inputRef as any}
              className={cx(props.inputClassName, "bg-transparent focus:outline-none w-full text-[#c1c1c1]")}
