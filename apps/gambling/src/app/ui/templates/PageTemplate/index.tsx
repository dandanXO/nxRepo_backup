      ...
      <div className={"h-full flex flex-row"}>
        ...
        <div className={cx("w-full h-full", {
          ...
          {isMobile  && isShowFooter &&
            <div className='flex justify-center text-white bg-[rgba(1,62,66,0.6)] p-4 pb-[80px]'>
          ...
          {!isMobile  && isShowFooter &&
            <div className='flex justify-center text-white bg-[rgba(0,91,70,0.8)] h-[400px]'>
              <div className={"flex gap-3 w-11/12 mt-3"}>
                ...
                <section className={"flex flex-col gap-3 w-3/12 items-start mt-3"}>
                  <div className='text-[#15F78C]'>Ajuda</div>
