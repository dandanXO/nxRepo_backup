  ...
  return (
    ...
    >
      <div className={""}>
        <CarouselImage
          alt={"banner_5"}
          src={`assets/${environment.uVersion}/${environment.assetVersionPrefix}/banner_5.png`}
          genieSrc={`assets/${environment.uVersion}/${environment.assetVersionPrefix}/genie_5.png`}
        />
