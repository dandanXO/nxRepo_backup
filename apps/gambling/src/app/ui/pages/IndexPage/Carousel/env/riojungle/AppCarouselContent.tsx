  ...
  return (
    ...
    >
      <div className={""}>
        <CarouselImage
          alt={"banner_1"}
          src={`assets/${environment.uVersion}/${environment.assetVersionPrefix}/banner_1.png`}
          genieSrc={`assets/${environment.uVersion}/${environment.assetVersionPrefix}/genie_1.png`}
        />
