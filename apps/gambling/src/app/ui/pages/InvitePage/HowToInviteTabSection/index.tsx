  ...
  return (
    <div className={"mb-[80px]"}>
      <HowToImageContainer className={"px-10"}>
        {contextHolder}
        <img className="hidden sm:block w-max-[100%] h-auto" src={"assets/topTitle1.ed9276b2.png"}/>
        <img className={"display sm:hidden"} src={"assets/team_title-7d5515fe.png"}/>
        ...
        <img className={"mb-2 hidden sm:block w-max-[100%] h-auto"} src={"assets/topTitle2.396e135e.png"}/>
        <img className={"mb-2 display sm:hidden"} src={"assets/invite-code-title-c456ebc9.png"}/>
