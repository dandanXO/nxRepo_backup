    ...
    <>
      ...
      <div className={"px-0 sm:px-10 w-full"}>
        ...
        <VIPBorderStyleContainer className={"flex flex-col text-left text-white items-start text-lg"}>
          <div className={"text-left w-full"}>TT Group ({environment.platformName}) sinceramente convida você a se juntar ao nosso canal de telegrama e vamos nos comunicar mais profundamente!</div>
          ...
          <ul className={"text-left w-full"}>
            ...
            <li>3. Compartilhe regularmente recompensas de envelope vermelho de troca oficial do TT Group ({environment.platformName}) todos os dias.</li>
