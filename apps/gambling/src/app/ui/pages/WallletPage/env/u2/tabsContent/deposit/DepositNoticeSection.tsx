...
export const DepositNoticeSection = () => {
  ...
  return (
    <div className={cx("mb-3 md:mb-5 p-2 md:p-3 lg:px-5 text-sm lg:text-base leading-5 lg:leading-6 border border-solid border-[var(--grayscale-20)] bg-[var(--grayscale-10)] text-[var(--secondary-main)] rounded-lg text-center")}>
