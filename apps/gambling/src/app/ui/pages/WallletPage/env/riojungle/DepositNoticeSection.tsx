...
export const DepositNoticeSection = () => {
  ...
  return (
    <div className={cx("p-2 md:p-3 lg:px-5 text-sm lg:text-base leading-5 lg:leading-6 border-solid border-[#333333] bg-[#1a1a1a] text-[#10b98f] rounded-lg text-center")}>
