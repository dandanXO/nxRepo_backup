...
export const PureUploadedPaymentReceiptPage = (props :UploadedPaymentReceiptPage) => {
    return (
        <CustomPage>
            <Content>
                <SuccessICON/>
            ...
            <ControlSection>
                <Button onClick={() => props.navigateToLoanDetails()}>Done</Button>
            </ControlSection>
        </CustomPage>
    )
}
...
const UploadedPaymentReceiptPage = () => {
    ...
    return (
        <PureUploadedPaymentReceiptPage navigateToLoanDetails={navigateToLoanDetails}/>
    )
}
