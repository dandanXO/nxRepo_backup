...
export const Page:ComponentStory<typeof PureExtendModal> = () => {
    return (
        <AppThemeProvider>
            <PureExtendModal currentProps={data} handlePostRepayCreate={{} as any}/>
        </AppThemeProvider>
    )
}
...
const data={
    ...
    "iconUrl": "https://platform-bucket-in.s3.ap-south-1.amazonaws.com/%E6%B5%8B%E8%AF%95%E7%94%A8/upload/icon_logo/yao.png",
    "extendable": false,
    "extended": false,
    "parentOrderNo": null,
    "chargeFeeDetail": {
    ...
    "recommendProducts": [
        {
            ...
            "top": true,
            "sort": 0,
            "backgroundUrl": "https://platform-bucket-in.s3.ap-south-1.amazonaws.com/%E6%B5%8B%E8%AF%95%E7%94%A8/upload/icon_logo/bg1.jpg"
        },
        {
            "productId": 4,
        ...
        {
            "productId": 5,
            "logoUrl": "https://platform-bucket-in.s3.ap-south-1.amazonaws.com/%E6%B5%8B%E8%AF%95%E7%94%A8/upload/icon_logo/8285116.png",
            "productName": "CC LOAN",
            "loanQuota": "200-3000",
            "term": "81Days",
            "interestRate": "40~50%",
